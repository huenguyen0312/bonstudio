            ...
            <ul class="pagination">
		        <?php if ($current_page > 1) :?>
                  <li class="pagination__item pagination__item--first">
                    <a href="<?php echo $base_url . $first_page ?>" class="pagination__link" aria-label="First page"><i class="icon icon--arrow-first">
                  ...
                  <li class="pagination__item pagination__item--prev">
                    <a href="<?php echo $base_url . $prev_page ?>" class="pagination__link" aria-label="Previous"><i class="icon icon--arrow-left-blue">
		        ...
		        <?php if ($current_page < $total_page):?>
                  <li class="pagination__item pagination__item--next">
                    <a href="<?php echo $base_url . $next_page ?>" class="pagination__link" aria-label="Next"><i class="icon icon--arrow-right-blue">
                        <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <li class="pagination__item pagination__item--last">
                    <a href="<?php echo $base_url . $last_page ?>" class="pagination__link" aria-label="Last page"><i class="icon icon--arrow-last">
                        <svg width="17" height="15" viewBox="0 0 17 15" fill="none" xmlns="http://www.w3.org/2000/svg">
